    ...
    <main id="main" className="about-page">
      <section className="about-hero section" data-cursor-dark>
        <div className="shell about-hero__grid">
          ...
          <p className="about-hero__intro">ProspectBArk opened in 2010 and has cared for NYC pets ever since. The job is simple to describe: show up, pay attention and treat every animal like an individual.</p>
        </div>
      </section>
