    ...
    <main id="main" className="about-page">
      <section className="about-hero section" data-cursor-dark>
        <div className="shell about-hero__grid">
          ...
          <div className="about-hero__image"><img src={groupImg} alt="A group of ProspectBArk daycare dogs" /><span><span className="brand">ProspectBArk</span> regulars</span></div>
          <p className="about-hero__intro"><span className="brand">ProspectBArk</span> opened in 2010 and has cared for NYC pets ever since. The job is simple to describe: show up, pay attention and treat every animal like an individual.</p>
        </div>
      </section>
      ...
      <section className="about-time section" aria-labelledby="about-time-title">
        ...
        <div className="shell about-time__line">
          <article><span>2010</span><div><h3><span className="brand">ProspectBArk</span> begins.</h3><p>Brooklyn pet care with a name people remember.</p></div></article>
          <i aria-hidden="true" />
